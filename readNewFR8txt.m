function S = readNewFR8txt(filename)
...
if ~(line(1)=='A')
    error('Cursor is at an unintended line, should''ve been A');
end
...
if line(1) == 'C' % fid is at lever press array
    ...
    error('Cursor is at an unintended line, should''ve been C');
end
...
if line(1) == 'D' % fid is at rewards array
    ...
    error('Cursor is at an unintended line, should''ve been D');
end

% Read Head Entries Array (E):
if line(1) == 'E' % fid is at head entry array
    S.headEntries = readArray('E', 'Q');
end
